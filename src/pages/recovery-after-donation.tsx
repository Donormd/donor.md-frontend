...
const list = [
  `Воздержаться от курения в течение часа после кроводач`,
  ...
  `Ограничений по вождению автомобиля в день кроводачи нет. За руль мотоцикла 
  можно садиться через 2 часа после кроводачи.`,
];
  ...
  return (
    <HeaderContentFooter background='/images/pages/welcome.png'>
      <Container>
        ...
        <Title as='h3' bold margin='40px 0 0 0'>
        ...
        <Paragraph>
          <Paragraph bold as='b' margin='0 0 0 0' color='red'>
