  ...
  <HeaderContentFooter background='/articles/images/pages/love-pic.png'>
    <Container>
      ...
      <p>
        ...
        технологические решения в сфере IT-разработок, походы в развитие донорского движения, но наш
        общий результа всё-таки зависит от тех, кто разделяет с нами концепцию “Люди помогают
        людям”.
      </p>
      <p>
        Мы всегда рады любой поддержке, которые объединит наши усилия в развитие донорского движения
        в Приднестровье.
      </p>
      <p>
      ...
      <p>
        ...
        материалов, технической поддержки проекта.
      </p>
